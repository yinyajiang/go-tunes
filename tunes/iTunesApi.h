...
public:
	...
	FUNC_DEF(int, CFDataGetLength, CFDataRef);
	...
	FUNC_DEF(CFTimeZoneRef, CFTimeZoneCreateWithName, CFAllocatorRef, CFStringRef, bool);
...
public:
	...
	FUNC_DEF(int, AFCConnectionOpen, void*, int, void**);
	...
	FUNC_DEF(int, AMDeviceSecureStartService, void*, void*, void*, void**);
	FUNC_DEF(int, AMDeviceStartService, void*, void*, void**, void*);
	FUNC_DEF(int, AMDeviceStopSession, void*);
	FUNC_DEF(int, AFCConnectionClose, void*);
	FUNC_DEF(int, AFCDeviceInfoOpen, void*, void**);
	FUNC_DEF(int, AFCFileInfoOpen, void*, void*, void**);
	FUNC_DEF(int, AFCKeyValueRead, void*, void**, void**);
	FUNC_DEF(int, AFCKeyValueClose, void*);
	...
	FUNC_DEF(int, AFCRemovePath, void*, void*);
	FUNC_DEF(int, AFCRenamePath, void*, void*, void*);
	FUNC_DEF(int, AFCFileRefOpen, void*, void*, unsigned long long, unsigned long long*);
	FUNC_DEF(int, AFCFileRefRead, void*, unsigned long long, void*, void*);
...
public:
	...
	FUNC_DEF(int, ATHostConnectionGetCurrentSessionNumber, void*);
	FUNC_DEF(void, ATHostConnectionSendFileProgress, void*, void*, void*, double, int, int);
	FUNC_DEF(void*, ATCFMessageCreate, int, void*, void*);
	FUNC_DEF(void*, ATHostConnectionCreateWithLibrary, void*, void*, void*);
	FUNC_DEF(int, ATHostConnectionCreate, void*);
	FUNC_DEF(void, ATHostConnectionSendPing, void*);
	FUNC_DEF(void, ATHostConnectionSendAssetMetricsRequest, void*, int);
	FUNC_DEF(void, ATHostConnectionInvalidate, void*);
	FUNC_DEF(void, ATHostConnectionClose, void*);
	FUNC_DEF(void, ATHostConnectionRelease, void*);
	FUNC_DEF(int, ATHostConnectionSendPowerAssertion, void*, void*);
	FUNC_DEF(int, ATHostConnectionRetain, void*);
	FUNC_DEF(int, ATHostConnectionSendMetadataSyncFinished, void*, void*, void*);
	FUNC_DEF(void, ATHostConnectionSendFileError, void*, void*, void*, int);
	FUNC_DEF(int, ATHostConnectionSendAssetCompleted, void*, void*, void*, void*);
	FUNC_DEF(void*, ATCFMessageGetName, void*);
...
CMobileDevice&		MobileDevice(bool newdll = true);
